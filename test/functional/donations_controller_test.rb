...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { adduper_id: @donation.adduper_id, money: @donation.money, order_id: @donation.order_id, student_id: @donation.student_id }
    end
  ...
  test "should update donation" do
    put :update, id: @donation, donation: { adduper_id: @donation.adduper_id, money: @donation.money, order_id: @donation.order_id, student_id: @donation.student_id }
    assert_redirected_to donation_path(assigns(:donation))
  end
