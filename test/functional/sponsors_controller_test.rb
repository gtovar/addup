...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { job: @sponsor.job, name: @sponsor.name, review: @sponsor.review, verified: @sponsor.verified }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { job: @sponsor.job, name: @sponsor.name, review: @sponsor.review, verified: @sponsor.verified }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
