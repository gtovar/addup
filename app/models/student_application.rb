...
validates :honor_code, :p1, :p2, :p3, :p4, :first_name, :last_name,:nationality,:city, :university, :crowdfundig_goal_usd, :time_frame, :presence => true
